...
- Фоновый планировщик проверяет состояние раз в минуту. 
- Напоминания отправляются только в рабочие дни, после наступления индивидуального дедлайна и при отсутствии отчета за локальную дату пользователя.
